...
@section('title', 'Tambah Supplier - Inventory App')
...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-primary">
            <h6 class="m-0 font-weight-bold text-white">Form Input Supplier Baru</h6>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="supplier_nama" id="supplier_nama" 
                                ...
                                placeholder="Masukkan nama supplier (contoh: PT. Jaya Abadi)" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="supplier_kontak" id="supplier_kontak" 
                                ...
                                placeholder="Masukkan nomor telepon kontak (contoh: 08123456789)" 
                                value="{{ old('supplier_kontak') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="supplier_alamat" id="supplier_alamat" rows="4" 
                                ...
                                placeholder="Masukkan alamat lengkap supplier..." required>{{ old('supplier_alamat') }}</textarea>
