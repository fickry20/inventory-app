...
@section('title', 'Edit Suku Cadang - Inventory App')

@section('content')

    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Suku Cadang</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-info">
            <h6 class="m-0 font-weight-bold text-white">Form Edit Suku Cadang: {{ $sukuCadang->suku_cadang_nama }}</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('suku-cadang.update', $sukuCadang->suku_cadang_id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="suku_cadang_kode" id="suku_cadang_kode" 
                                ...
                                value="{{ old('suku_cadang_kode', $sukuCadang->suku_cadang_kode) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="suku_cadang_nama" id="suku_cadang_nama" 
                                ...
                                value="{{ old('suku_cadang_nama', $sukuCadang->suku_cadang_nama) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select name="suku_cadang_supplier_id" id="suku_cadang_supplier_id" 
                                ...
                                @foreach($suppliers as $supplier)
                                    <option value="{{ $supplier->supplier_id }}" {{ old('suku_cadang_supplier_id', $sukuCadang->suku_cadang_supplier_id) == $supplier->supplier_id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="suku_cadang_kategori" id="suku_cadang_kategori" 
                                ...
                                value="{{ old('suku_cadang_kategori', $sukuCadang->suku_cadang_kategori) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="suku_cadang_satuan" id="suku_cadang_satuan" 
                                ...
                                value="{{ old('suku_cadang_satuan', $sukuCadang->suku_cadang_satuan) }}" required>
                        ...
                        <div class="form-group">
                            <label for="suku_cadang_stok_total" class="font-weight-bold text-gray-900">Stok Total <span class="text-danger">*</span></label>
                            <input type="number" name="suku_cadang_stok_total" id="suku_cadang_stok_total" 
                                ...
                                value="{{ old('suku_cadang_stok_total', $sukuCadang->suku_cadang_stok_total) }}" min="0" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="suku_cadang_reorder_point" id="suku_cadang_reorder_point" 
                                ...
                                value="{{ old('suku_cadang_reorder_point', $sukuCadang->suku_cadang_reorder_point) }}" min="0" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="suku_cadang_stok_minimum" id="suku_cadang_stok_minimum" 
                                ...
                                value="{{ old('suku_cadang_stok_minimum', $sukuCadang->suku_cadang_stok_minimum) }}" min="0" required>
